...
import { BUNIIPAD_ADDRESS, BUNIIPAD_ABI, TEAM_WALLETS } from "@/lib/buniiPadContract";
  ...
  return (
    <section style={{ border: RULE, background: color.paper, boxShadow: offset(color.inkSoft) }}>
      ...
      <div style={{ padding: "18px" }}>
        ...
        {isSuccess && (
          <p style={{ fontFamily: font.mono, fontSize: "0.7rem", color: color.brand, margin: "12px 0 0" }}>
