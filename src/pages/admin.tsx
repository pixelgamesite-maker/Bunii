...
const KEY_STORAGE = "buniipad_admin_key";
    ...
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "50px 22px 90px" }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: isCurrent ? color.brand : color.paper,
      ...
      <button
        ...
        style={{
          ...
          boxShadow: csvText.trim() && adminKey.trim() ? offset(color.brand, 5, 5) : "none",
        }}
      >
      ...
      {result && (
        <section style={{ border: RULE, background: color.brand, color: color.paper, marginBottom: "20px" }}>
          <div style={{ padding: "18px" }}>
      ...
      {result && (
        <>
          ...
          {isSuccess && (
            <p style={{ fontFamily: font.mono, fontSize: "0.74rem", color: color.brand, marginTop: "14px" }}>
